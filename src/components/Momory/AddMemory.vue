    ...
    <v-stepper-items>
      ...
      <v-stepper-content step="2" class="pa-0">
        <v-card class="transparent d-flex align-center" outlined tile>
          ...
          <v-card-text class="title">
            <div>
              Le monde se souviendra à vie de votre passage à
              <span class="event_name">{{ event['name'] }}</span>
            </div>
          </v-card-text>
        </v-card>
      ...
      <v-stepper-content step="3" class="pa-0">
        ...
        <v-card-text class="pa-0 text-h6 my-2 d-flex justify-space-between">
          ...
          <div class="white--text" style="margin-left:15px;">Validation des CGV et Email</div>
        </v-card-text>
        ...
        <div class="d-flex my-3 justify-center mt-12 mb-6 pa-3">
          <v-checkbox
            ...
            hide-details
          ></v-checkbox>
          <button style="margin-top: 5px;margin-left: 5px;" @click="downloadcgv"><u><b>CGV standards</b></u></button>
        </div>
        <v-text-field
      ...
      <v-stepper-content step="4" class="pa-0">
        <div class="">
          ...
          <v-card-text class="title teal--text text-center pt-0 mb-6 pa-3">
