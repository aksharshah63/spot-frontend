<template>
  ...
  export default {
    name: 'EventMemoryModerationComponent',
    data: () => ({
          selected: [],
          search: '',
          headers: [
    ...
    methods: {
      async tab_type(type)
      {
        ...
        if(this.tabtype=='to_validate')
        {
          this.loader= true;
          axios
            .get(this.$hostname + `admin/get_pending_event_memories/${this.$route.params.id}`, {
              headers: {
        ...
        else if(this.tabtype=='refused')
        {
          this.loader= true;
          axios
            .get(this.$hostname + `admin/get_rejected_event_memories/${this.$route.params.id}`, {
              headers: {
                "x-access-token": localStorage.getItem("adminAccessToken"),
              },
            })
        ...
        else
        {
          this.loader= true;
          axios
            .get(this.$hostname + `admin/get_event_memories/${this.$route.params.id}`, {
              headers: {
                "x-access-token": localStorage.getItem("adminAccessToken"),
              },
            })
  ...
  <style src="../Memories/Basic.scss" lang="scss"></style>
